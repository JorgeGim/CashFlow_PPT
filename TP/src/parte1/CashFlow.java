...
public class CashFlow {
	...
	public ArrayList<int[]> CombinacionesValidas(int[][] matriz){
		...
		for ( int i = 0 ; i <matriz.length ; i++){// n^n iteraciones(tama�o de la matriz)
	...
	//nuestro objetivo con este metodo es contrar las combinaciones validas, y pasarlas a un array
